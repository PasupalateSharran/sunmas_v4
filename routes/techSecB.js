...
router.get('/', async (req, res, next) => {
  try {
    ...
    if (data) {
      const { techSecB,Technologies } = data; // Retrieve the 'techSecA' section
      res.render('tech_sec_B', { techSecB,title : Technologies.box2.title }); // Pass the data to the EJS template
    } else {
