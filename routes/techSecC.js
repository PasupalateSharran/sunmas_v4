...
router.get('/', async (req, res, next) => {
  try {
    ...
    if (data) {
      const { techSecC,Technologies } = data; // Retrieve the 'techSecA' section
      res.render('tech_sec_C', { techSecC,title : Technologies.box3.title }); // Pass the data to the EJS template
    } else {
