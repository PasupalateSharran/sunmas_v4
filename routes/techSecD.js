...
router.get('/', async (req, res, next) => {
  try {
    ...
    if (data) {
      const { techSecD,Technologies } = data; // Retrieve the 'techSecA' section
      res.render('tech_sec_D', { techSecD,title: Technologies.box4.title }); // Pass the data to the EJS template
    } else {
